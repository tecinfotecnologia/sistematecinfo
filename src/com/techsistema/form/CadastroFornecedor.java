...
import com.techsistema.dao.FornecedorDAO;
import com.techsistema.tm.FornecedorTableModel;
...
public class CadastroFornecedor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnForm.setPreferredSize(new java.awt.Dimension(380, 79));
            ...
            .addGroup(pnFormLayout.createSequentialGroup()
                .addGroup(pnFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnFormLayout.createSequentialGroup()
                        ...
                        .addComponent(ftfFone, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        if (validarFormulario()) {
            ...
            fornecedor.setFone(ftfFone.getText().trim());
    ...
    private void tbGradeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbGradeMouseClicked
        if (evt.getClickCount() == 2) {
            ...
            ftfFone.setValue(fornecedor.getFone());
