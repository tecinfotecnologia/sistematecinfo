...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btVenda.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/venda.png"))); // NOI18N
        ...
        btVenda.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/venda-foco.png"))); // NOI18N
        ...
        btCompra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/compra.png"))); // NOI18N
        ...
        btCompra.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/compra-foco.png"))); // NOI18N
        ...
        btProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/produto.png"))); // NOI18N
        ...
        btProduto.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/produto-foco.png"))); // NOI18N
        ...
        btCliente.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/cliente.png"))); // NOI18N
        ...
        btCliente.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/cliente-foco.png"))); // NOI18N
        ...
        btFornecedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/fornecedor.png"))); // NOI18N
        ...
        btFornecedor.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/fornecedor-foco.png"))); // NOI18N
        ...
        btSair.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/sair.png"))); // NOI18N
        btSair.setText("Sair");
        btSair.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        btSair.setFocusable(false);
        btSair.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        btSair.setMargin(new java.awt.Insets(2, 12, 2, 12));
        btSair.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/com/techsistema/form/img/sair-foco.png"))); // NOI18N
        ...
        miCidades.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F5, 0));
        miCidades.setText("Cadastrar Cidades");
        miCidades.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                miCidadesActionPerformed(evt);
            }
        });
        menuCadastros.add(miCidades);
        ...
        jMenuItem1.setText("Vendas X Cliente");
    ...
    private void miCidadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_miCidadesActionPerformed
      CadastroCidades c = new CadastroCidades();
        desktopPane.add(c);
        c.setVisible(true);
    }//GEN-LAST:event_miCidadesActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
       RelatorioCliente v = new RelatorioCliente();
        desktopPane.add(v);
        v.setVisible(true);
